                        ...
                        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <input className="w-full bg-white border-none rounded-2xl h-14 px-6 focus:ring-2 focus:ring-black transition-all" placeholder="John" />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-sm font-medium">Last Name</label>
                                    <input className="w-full bg-white border-none rounded-2xl h-14 px-6 focus:ring-2 focus:ring-black transition-all" placeholder="Doe" />
                                </div>
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm font-medium">Email Address</label>
                                <input className="w-full bg-white border-none rounded-2xl h-14 px-6 focus:ring-2 focus:ring-black transition-all" placeholder="john@example.com" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm font-medium">Message</label>
                                <textarea className="w-full bg-white border-none rounded-2xl p-6 min-h-[150px] focus:ring-2 focus:ring-black transition-all" placeholder="How can we help you?" />
                            </div>
